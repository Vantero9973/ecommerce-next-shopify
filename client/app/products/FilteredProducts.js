...
const pages = [{ name: "Products", href: "/products", current: true }];
...
export default function FilteredProducts({ sortedProducts }) {
  ...
  const filterProducts = () => {
    return sortedProducts.filter((product) => {
      const profileMatch =
        ...
        (selectedProfile.includes("aggressive") &&
          product.metadata.aggressive === "true") ||
        (selectedProfile.includes("moderate") &&
          product.metadata.moderate === "true") ||
        (selectedProfile.includes("neutral") &&
          product.metadata.neutral === "true");
      ...
      return profileMatch && brandMatch && priceMatch;
    });
  };
                          ...
                          {section.options.map((option, optionIdx) => (
                            ...
                            >
                              <input
                                ...
                                checked={
                                  section.id === "profile"
                                    ? selectedProfile.includes(option.value)
                                    : section.id === "brands"
